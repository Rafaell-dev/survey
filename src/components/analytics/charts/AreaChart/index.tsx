...
export default function AreaChart({ question, visualization }: QuestionChartProps) {
      ...
      series: [
        {
          ...
          areaStyle: {
            color: {
              ...
              x: 0, y: 0, x2: 0, y2: 1,
              colorStops: [{
                  offset: 0, color: 'rgba(16, 185, 129, 0.5)' // emerald-500 50%
              }, {
                  offset: 1, color: 'rgba(16, 185, 129, 0.05)' // emerald-500 5%
              }]
            }
          },
          label: {
